...
class ExpandableTextViewAdapter(var context: Context): BaseExpandableListAdapter() {
    ...
    var answers = arrayOf<Array<String>>(arrayOf<String>("answer 1"), arrayOf<String>("answeer 2"), arrayOf<String>("Your files remain on the same location on your phone even after they are hidden. We do not upload it to cloud."), arrayOf<String>("You can lock any file that you wish to with this application")
        , arrayOf<String>("answeer 6"), arrayOf<String>("answeer 7"), arrayOf<String>("You will lose all your hidden files if you factory reset your phone"))
